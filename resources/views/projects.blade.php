    ...
    <script type="text/javascript">
        ...
        */
        function storeProject() {
            ...
            let url = $('meta[name=app-url]').attr("content") + "/api/projects";
            let data = {
                name: $("#name").val(),
        ...
        */
        function editProject(id) {
            let url = $('meta[name=app-url]').attr("content") + "/api/projects/" + id;
            $.ajax({
                url: url,
                type: "GET",
                success: function(response) {
        ...
        */
        function updateProject() {
            $("#save-project-btn").prop('disabled', true);
            let url = $('meta[name=app-url]').attr("content") + "/api/projects/" + $("#update_id").val();
            let data = {
                id: $("#update_id").val(),
                name: $("#name").val(),
                description: $("#description").val(),
